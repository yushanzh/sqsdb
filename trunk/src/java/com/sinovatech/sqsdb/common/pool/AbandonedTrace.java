...
/**
 * Tracks object usage for recovering and reporting
 * abandoned objects.
 * @author Glenn L. Nielsen
 * @version $Revision: 1.2 $ $Date: 2009/07/10 01:31:23 $
 */
public class AbandonedTrace {
	private static final Log log = LogFactory.getLog(AbandonedTrace.class);
    /** Date format */
    private static SimpleDateFormat format = new SimpleDateFormat
        ("'FTPClient object created' yyyy-MM-dd HH:mm:ss " +
    ...
    public void printStackTrace() {
        if (createdBy != null) {
            log.debug(format.format(new Date(createdTime)));
